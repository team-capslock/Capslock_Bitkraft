...
$store_admin_email = get_bloginfo( 'admin_email' );
$store_admin_name = get_bloginfo( 'admin_name' );
            ...
            <div class="max-w-md mx-auto">
              ...
              "></div>
                <div class="p-4 sm:p-6">
                    <p class="font-bold text-center text-gray-700 text-[30px] leading-7 mb-1">
                        Welcome to V-Track

                    </p>

                    <p class="text-[#7C7C80] text-center font-[15px] mt-6">
                        Signup for a New Merchant Account
                    </p>
                    ...
                    <p class="text-[#7C7C80] font-[15px] mt-6">
                        By signing in to V-Track, you agree to our terms of service.
                    </p>
                </div>
            </div>
        </div>
...
function signup() {
    ...
    var raw = JSON.stringify({
        "store_data": {
            ...
            "address": "<?php echo $store_address . $store_address_2?>",
            "city": "<?php echo $store_name ?>",
            "state": "<?php echo $store_postcode ?>",
            "country": "<?php echo $store_country ?>",
            "postal_code": "<?php echo $store_postcode ?>",
            "url": "<?php echo $store_url ?>"
        },
        "email": "<?php echo $store_admin_email ?>",
        "password": "<?php echo $store_name ?>",
        "name": "<?php echo $store_admin_name ?>",
    });
    ...
    fetch("<?php echo apiUrl(); ?>api/register", requestOptions)
